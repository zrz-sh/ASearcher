...
python scripts/run_infer_and_eval_batching.py \
  --stage eval \
  --response_root /mnt/mnt/public/zhangruize/MAS/repo/ASearcher/widesearch_evaluation/widesearch_format_result \
  --result_save_root /mnt/mnt/public/zhangruize/MAS/repo/ASearcher/widesearch_evaluation/widesearch_format_result/eval_results \
  ...
  --model_config_name ASearcher-qwen2.5-7b \
  --trial_num 4
